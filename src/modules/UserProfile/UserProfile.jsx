			...
			<div className="user-profile">
				<div className="user-data-wrapper">
					<div className="user-image-wrapper">
						{user.image ? <img src={user.image.base64} alt="user profile" /> : <Logo />}
					</div>
					<div className="user-data">
            <div className="actions">
							<Button type="action" onClick={toggleChangePhotoOpen}>
								<i className="fa fa-camera" aria-hidden="true"></i>
							</Button>
              <Button type="action" onClick={toggleEditAccountOpen}>
              ...
              <Button type="action" onClick={toggleEditAccountOpen}>
				...
				{isDeleteAccountOpen && (
					<ConfirmModal
						...
						toggleModal={toggleDeleteAccountOpen}
				...
				{isEditAccountOpen && (
					<Modal>
						<div className="modal-content">
							...
							<div className="modal-content">
								<EditUserProfile toggleModal={toggleEditAccountOpen} user={user} />
							</div>
						</div>
					</Modal>
				)}
				...
				{isChangePhotoOpen && (
					<Modal>
						<div className="modal-content change-photo">
							...
							<div className="modal-content">
								<ChangeProfilePhoto toggleModal={toggleChangePhotoOpen} user={user} />
							</div>
						</div>
					</Modal>
				)}
